...
运行：
    D:\MockC\竞赛\CUMCM2026\.venv\Scripts\python.exe solve.py

程序读取附件 1/2，求解四问，填写附件 3 的四个 Excel 模板，并在
``计算结果``和``说明书/figures``中保存复核数据及绘图。
"""
...
TEMPLATE_DIR = ATTACHMENT_DIR / "附件3"
RESULT_DIR = ROOT / "计算结果"
FIGURE_DIR = ROOT / "说明书" / "figures"
